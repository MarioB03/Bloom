...
interface AppAchievementToastProps {
  emoji: string;
  title: string;
  description: string;
  onDismiss: () => void;
...
export function AppAchievementToast({ emoji, title, description, onDismiss }: AppAchievementToastProps) {
    ...
    <Animated.View style={[styles.container, animStyle]}>
      <View style={styles.card}>
        ...
        <View style={styles.textWrap}>
          <Text style={styles.label}>{strings.achievements.newAchievement}</Text>
